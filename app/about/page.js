  ...
  return (
    <main className="px-6 py-10 space-y-6 bg-gray-50 ">
      ...
      <p className="px-10 text-xl">
        Bellal Hossen & Associates is a certified tax consultancy firm with over
        20 years of experience. Led by Mr. Bellal Hossen (CMA Aus, M.Com, CA
        Part, ITP), we provide expert guidance in tax, VAT, and company law
        matters.
      </p>
