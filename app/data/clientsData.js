...
import dtm from "@/public/images/dtm.png";

const companies = [
  { id: "dblGroup", name: "DBL Group", logo: dblGroup },
  { id: "btlGroup", name: "BTI", logo: bti },
  { id: "bComplex", name: "Bashundhara Complex", logo: bComplex },
  { id: "bCement", name: "Bashundhara Cement", logo: bCement },
  { id: "bDredging", name: "Bashundhara Dredging ", logo: bDredging },
  { id: "bPaper", name: "Bashundhara Paper", logo: bPaper },
  { id: "kaiAltech", name: "Kai Altech", logo: kaiAltech },
  { id: "Olila", name: "Olila", logo: Olila },
  { id: "colorWoven", name: "ColorWoven", logo: colorWoven },
];

const companies2 = [
  { id: "bagsandpacks", name: "Bags and Packs", logo: bagsandpacks },
  { id: "raduga", name: "Raduga", logo: raduga },
  { id: "faisalandfahad", name: "Faisal and Fahad", logo: faisalandfahad },
  { id: "sinobangla", name: "Sino Bangla", logo: sinobangla },
  { id: "liberty", name: "Liberty", logo: liberty },
  { id: "interpac", name: "Interpac", logo: interpac },
  { id: "integraphics", name: "InteGraphics", logo: integraphics },
  { id: "dtm", name: "DTM", logo: dtm },
];
